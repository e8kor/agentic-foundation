...
1. **`CORE.md`** — the framework contract (19 sections): motivation, identity,
   contract, directory layout, the five stores, manifest, load policy, extension
   points, plugin schema, hooks, core skills, curation, memory lifecycle,
   authoring, evaluation, versioning, hard rules, verify, and security & trust.
